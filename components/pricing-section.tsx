...
const pricingPlans = [
  {
    name: "Free",
    price: "Free",
    description: "For individuals exploring Collabify",
    features: ["Up to 3 projects", "Basic collaboration tools", "Community support"],
    popular: false,
    cta: "Get Started",
  },
  {
    ...
    features: ["Unlimited projects", "Advanced collaboration", "Priority support", "Asset library", "Version history"],
    popular: true,
  ...
  },
  {
    ...
    features: ["Everything in Pro", "Team analytics", "Shared libraries", "Custom integrations", "Dedicated support"],
    popular: false,
    cta: "Contact Sales",
  },
]
    ...
    <section className="relative py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">Start free. Upgrade as your projects grow.</p>
        ...
        >
          <p className="text-white/60 mb-4">Need enterprise features or self-hosting?</p>
          <motion.button
