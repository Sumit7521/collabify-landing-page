        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Collaborate on <strong>projects</strong> <span>in</span> <br />
                <strong>real-time</strong> <em className="italic"></em>
              </h1>
            </motion.div>
            ...
            >
              Collabify brings your team together with workspaces, shared assets, and real-time editing — all in one
              place.
            </motion.p>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Trusted by creative teams at</p>
