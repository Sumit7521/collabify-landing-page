        ...
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Video Rooms now live 🎥</h2>
              <p className="text-white/60 mb-8">
                Host real-time video meetings directly inside your workspace. No extra apps needed.
              </p>
              <svg
                width="100"
                height="50"
