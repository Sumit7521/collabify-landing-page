...
const testimonials = [
  {
    name: "Arjun Mehta",
    username: "@arjdev",
    body: "Collabify feels like Notion, Figma, and Dropbox had a baby. My whole workflow is finally in one app.",
    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Sara Lin",
    username: "@sara.codes",
    body: "As a remote designer, I can whiteboard, share assets, and edit docs with my team instantly.",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "David Kim",
    username: "@davidk",
    body: "We replaced 4 tools with Collabify and cut onboarding time in half.",
        ...
        <div className="mx-auto max-w-[540px]">
          <div className="flex justify-center">
            ...
            >
              ...
              <span className="relative text-white">Stories</span>
            </button>
          </div>
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            From startups to agencies, Collabify helps teams ship faster together.
          </p>
        </div>
